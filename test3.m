...
% Last Modified by GUIDE v2.5 01-Mar-2017 17:12:29
...
bg = imread('blood.jpg'); imagesc(bg);
...
a1=str2num(char(get(handles.edit7,'String')));
b1=str2num(char(get(handles.edit8,'String')));
c1=str2num(char(get(handles.edit9,'String')));
d1=str2num(char(get(handles.edit10,'String')));
e1=str2num(char(get(handles.edit11,'String')));

labresult=a1+b1+c1+d1+e1;
disp('labresult');
disp(labresult);
